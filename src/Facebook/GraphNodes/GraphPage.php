...
class GraphPage extends GraphNode
{
    ...
    protected static $graphObjectMap = [
        'best_page' => '\\' . \Facebook\GraphNodes\GraphPage::class,
        'global_brand_parent_page' => '\\' . \Facebook\GraphNodes\GraphPage::class,
        'location' => '\\' . \Facebook\GraphNodes\GraphLocation::class,
        'cover' => '\\' . \Facebook\GraphNodes\GraphCoverPhoto::class,
        'picture' => '\\' . \Facebook\GraphNodes\GraphPicture::class,
    ];
